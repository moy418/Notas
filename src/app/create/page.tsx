...
export default function CreateInvoice() {
    ...
    const [formData, setFormData] = useState({
        ...
        taxLocation: 'texas', // Default to Texas (8.25%)
        paymentMethod: 'cash',
        financingCompany: '',
        notes: '',
        status: 'paid'
        ...
        <div className="dashboard-layout fade-in">
            ...
            <main className="main-content">
                <header className="page-header">
                    ...
                    <p>Generate a new premium invoice</p>
                </header>
                    ...
                    <div className="form-section">
                        ...
                        <div className="grid-2">
                            ...
                            <div className="col-span-2">
                                {/* Mapbox AddressAutofill handles the dropdown and autofills inputs with matching autocomplete tags inside the same form */}
                                <AddressAutofill
                        ...
                        <div className="invoice-settings">
                            ...
                            {formData.paymentMethod === 'financing' && (
                                <div className="input-group">
                                    ...
                                    <input name="financingCompany" placeholder="E.g. Snap Finance" className="premium-input" onChange={(e) => setFormData({ ...formData, financingCompany: e.target.value })} />
                                </div>
                            )}
                            <div className="input-group">
